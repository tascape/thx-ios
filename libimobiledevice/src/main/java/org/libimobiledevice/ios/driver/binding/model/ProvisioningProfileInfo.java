...
public class ProvisioningProfileInfo {
    private static final Logger LOG = LoggerFactory.getLogger(ProvisioningProfileInfo.class);
    ...
    public static List<ProvisioningProfileInfo> read(PointerByReference ptr, int count)
        ...
        List<ProvisioningProfileInfo> res = new ArrayList<>();
    ...
    public String toString() {
        return "uuid:" + getUuid() + "expires:" + expirationDate + ",devices : " + getDevices() + "ents :"
            + getEntitlements();
    }
}
