 ...
 * @author linsong wang
 */
public class UiAutomationViewerOld implements UiAutomationTest {
    private static final org.slf4j.Logger LOG = LoggerFactory.getLogger(UiAutomationViewerOld.class);
    ...
    public static void main(String[] args) {
        String instruction = "Usage:\n"
            + "java -cp $YOUR_CLASSPATH com.tascape.qa.th.ios.tools.UiAutomationViewer APP_NAME";
        LOG.info("--------\n{}", instruction);

        SystemConfiguration.getInstance();
        UiAutomationViewerOld debugger = new UiAutomationViewerOld();
